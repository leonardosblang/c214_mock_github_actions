...
class testeProfessor(softest.TestCase):
    ...
    def test_Atendimento_fail(self):
        mock_professor.change_horario_de_atendimento.return_value = "Segunda 17:30"
        self.soft_assert(self.assertEqual, mock_professor.change_horario_de_atendimento(), "Segunda 17:00",
                         "Horario errado")
    ...
    def test_Periodo_fail(self):
        mock_professor.change_periodo.return_value = "Noturno"
        self.soft_assert(self.assertEqual, mock_professor.change_periodo(), "Integral", "Periodo errado")

        self.assert_all()

    def test_Salario_fail(self):
        mock_professor.salario.return_value = 100
        self.soft_assert(self.assertEqual, mock_professor.salario(), 200, "Salario errado")
